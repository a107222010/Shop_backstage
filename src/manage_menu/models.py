...
class Customized(models.Model):
    ...
    sp1_number = models.ForeignKey('Singleplus1', models.DO_NOTHING, db_column='sp1_number', blank=True, null=True)
    sp2_number = models.ForeignKey('Singleplus2', models.DO_NOTHING, db_column='sp2_number', blank=True, null=True)
    sp3_number = models.ForeignKey('Singleplus3', models.DO_NOTHING, db_column='sp3_number', blank=True, null=True)
...
class CustomizedPlus(models.Model):
    ...
    mp_number = models.ForeignKey('Multipleplus', models.DO_NOTHING, db_column='mp_number', primary_key=True)
...
class ShopDetail(models.Model):
    shop_username = models.CharField(primary_key=True,max_length=50)
